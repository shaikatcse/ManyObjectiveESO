...
class Everything1{
	Solution solution;
	int type, n;
	public Everything1(Solution solution, int type, int n) {
...
public class MOEADEA1 extends MOEAD {

  /** 
   * Constructor
   * @param problem Problem to solve
   */
  public MOEADEA1(Problem problem) {
    super (problem) ;
...
*/
    ...
    ArrayList<Everything1> offSpring = new ArrayList<>();
   ...
   // 	System.out.println(lambda_[i][0] + " " + lambda_[i][1]) ;
    ...
    do {
      ...
      for (int i = 0; i < populationSize_; i++) {
        ...
        offSpring.add(new Everything1(child, type, n));
...
if(evaluations_%11==0) {
         ...
         // System.out.println(offSpring.size());
          for(int i1=0;i1<offSpring.size();i1++) {
        	  ...
        	  Everything1 e = offSpring.get(i1);
          ...
          for(int i2=0;i2<offSpring.size();i2++) {
        	  ...
        	  Everything1 e = offSpring.get(i2);
