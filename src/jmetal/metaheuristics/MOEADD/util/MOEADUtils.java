package jmetal.metaheuristics.MOEADD.util;

import java.util.ArrayList;
import java.util.List;
import jmetal.core.Solution;
import jmetal.metaheuristics.MOEADD.util.distance.Distance;
import jmetal.metaheuristics.MOEADD.util.distance.impl.EuclideanDistanceBetweenSolutionAndASolutionListInObjectiveSpace;
import jmetal.metaheuristics.MOEADD.util.errorchecking.JMetalException;
...
public class MOEADUtils {
  ...
  public static void randomPermutation(int[] perm, int size) {
	  //PseudoRandom randomGenerator = new PseudoRandom();
