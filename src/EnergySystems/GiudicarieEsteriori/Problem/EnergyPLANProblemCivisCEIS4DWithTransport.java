...
public class EnergyPLANProblemCivisCEIS4DWithTransport extends Problem {
	 ...
	 */
	public EnergyPLANProblemCivisCEIS4DWithTransport(String solutionType) {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		writeModificationFile(pv, oilBoilerHeatPercentage,
				LPGBoilerHeatPercentage, biomassBoilerHeatPercentage,
				biomassCHPHeatPercentage, hpHeatPercentage, reducedPetrolDemandInGWh, reducedDieselDemandInGWh, elecCarElectricityDemandInGWh, "NC");
