...
import EnergySystems.GiudicarieEsteriori.Problem.MaOOCEIS4D_Cons;

public class MaOOCEIS4D_ConMain {
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		String[] algorithms = {"NSGAIII", "cMOEAD"};
		String baseDirectory = ".\\Results\\MaOOCEIS4D\\Constrained\\";
		...
		for (int algorithmNo = 0; algorithmNo < algorithms.length; algorithmNo++) {
			...
			for (int i = 0; i < numberOfRun; i++) {
				...
				problem = new MaOOCEIS4D_Cons("Real");
			...
			/*	ExtractEnergyPLANParametersTrentoProvinceV10 ex = new ExtractEnergyPLANParametersTrentoProvinceV10(
				...
				population.printVariablesToFile(folder + "\\AllVAR"+i );
				// population.printFeasibleVAR("VAR");
				logger_.info("Objectives values have been writen to file FUN");
				population.printObjectivesToFile(folder + "\\AllFUN"+i);
