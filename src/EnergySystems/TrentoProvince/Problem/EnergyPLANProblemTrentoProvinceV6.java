 ...
 */
public class EnergyPLANProblemTrentoProvinceV6 extends Problem {
	...
	public EnergyPLANProblemTrentoProvinceV6(String solutionType, String simulatedYear) {
		
		this.simulatedYear=simulatedYear;
				
		numberOfVariables_ = 16;
	...
	public void evaluate(Solution solution) throws JMException {
		...
		try {
			...
			if(simulatedYear.equals("2025")) {
				co2InImportedEleOil  =( (elecImport *1.83/100) * 0.267 );
				co2InImportedEleNGas =( (elecImport *47.96/100) * 0.202);
			
			}else if(simulatedYear.equals("2030")) {
				co2InImportedEleOil =( (elecImport *0.66/100) * 0.267  );
				co2InImportedEleNGas =( (elecImport *43.94/100) * 0.202  );
			}else if(simulatedYear.equals("2050")) {
				co2InImportedEleNGas =( (elecImport *12/100) * 0.202 );
			}
	...
	void writeIntoInputFile(double pv, double oilBoilerHeatDemand,
		...
		String path=""; 
		if(simulatedYear.equals("2025") ){
			path =".\\EnergyPLAN_12.3\\energyPlan Data\\Data\\PEAP\\PEAP_PAT_LC_2025_DH_v6_opt.txt";
		}else if(simulatedYear.equals("2030") ){
			path =".\\EnergyPLAN_12.3\\energyPlan Data\\Data\\PEAP\\PEAP_PAT_LC_2030_DH_v6_opt.txt";
		}else if(simulatedYear.equals("2050")) {
			path =".\\EnergyPLAN_12.3\\energyPlan Data\\Data\\PEAP\\PEAP_PAT_LC_2050_DH_v6_opt.txt";
		}
